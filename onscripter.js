...
var ASM_CONSTS = {
  674120: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 674267: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 ...
 682058: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 682141: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 682210: () => { return window.innerWidth; },  
 682240: () => { return window.innerHeight; }
};
